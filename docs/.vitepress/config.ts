      ...
      '/internals/': [
        {
          ...
          items: [
            ...
            { text: 'Fiber-central game (plan)', link: '/internals/fiber-game' },
            { text: 'Multi-user build plan', link: '/internals/multi-user-plan' },
            { text: 'Phase 2 live run (runbook)', link: '/internals/phase2-live-run' },
          ],
        },
      ],
    },
